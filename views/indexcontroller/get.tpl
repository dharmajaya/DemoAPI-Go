...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Demo API">
    <meta name="author" content="Demo API Contents">
    ...
    <div class="container-fluid">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav pull-right">
          ...
          {{else}}
          <form class="navbar-form navbar-left" role="signin" action="//{{.base_url}}/user/signin" method="POST">
          ...
          <li><p class="navbar-btn"><a href="//{{.base_url}}/user/signup" class="btn btn-success" role="button">Sign up</a></p></li>
          {{end}}
