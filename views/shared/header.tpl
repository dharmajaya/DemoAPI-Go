  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
       <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/"><img src="//{{.base_url}}/static/img/go_logo.png" alt="Some Inc. Logo"></a>
      </div><!-- end navbar head -->
      {{if .Session}}
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav pull-right">
          <li><p class="navbar-text">Welcome, {{.Session.firstname}}</p></li>
          <li><a href="//{{.base_url}}/user/signout"><span class="glyphicon glyphicon-off"></span></a></li>
